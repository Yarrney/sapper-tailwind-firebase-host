...
const css = {
	code: "h1.svelte-1kk9opm,figure.svelte-1kk9opm{text-align:center;margin:0 auto}h1.svelte-1kk9opm{font-size:2.8em;text-transform:uppercase;font-weight:700;margin:0 0 0.5em 0}figure.svelte-1kk9opm{margin:0 0 1em 0}@media(min-width: 480px){h1.svelte-1kk9opm{font-size:4em}}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<style>\\n\\th1, figure, p {\\n\\t\\ttext-align: center;\\n\\t\\tmargin: 0 auto;\\n\\t}\\n\\n\\th1 {\\n\\t\\tfont-size: 2.8em;\\n\\t\\ttext-transform: uppercase;\\n\\t\\tfont-weight: 700;\\n\\t\\tmargin: 0 0 0.5em 0;\\n\\t}\\n\\n\\tfigure {\\n\\t\\tmargin: 0 0 1em 0;\\n\\t}\\n\\n\\timg {\\n\\t\\twidth: 100%;\\n\\t\\tmax-width: 400px;\\n\\t\\tmargin: 0 0 1em 0;\\n\\t}\\n\\n\\tp {\\n\\t\\tmargin: 1em auto;\\n\\t}\\n\\n\\t@media (min-width: 480px) {\\n\\t\\th1 {\\n\\t\\t\\tfont-size: 4em;\\n\\t\\t}\\n\\t}\\n</style>\\n\\n<svelte:head>\\n\\t<title>Sapper project template</title>\\n</svelte:head>\\n\\n<h1>Great success!</h1>\\n\\n<figure>\\n\\t<object class=\\\"w-full\\\" type=\\\"image/svg+xml\\\" data=\\\"illustration.svg\\\">Illustration<object>\\n\\t<figcaption>HIGH FIVE!</figcaption>\\n</figure>\\n\"],\"names\":[],\"mappings\":\"AACC,iBAAE,CAAE,MAAM,eAAI,CAAC,AACd,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,CAAC,CAAC,IAAI,AACf,CAAC,AAED,EAAE,eAAC,CAAC,AACH,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AACpB,CAAC,AAED,MAAM,eAAC,CAAC,AACP,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,AAClB,CAAC,AAYD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,EAAE,eAAC,CAAC,AACH,SAAS,CAAE,GAAG,AACf,CAAC,AACF,CAAC\"}"
};
...
/* src/routes/timesheets.svelte generated by Svelte v3.6.9 */

const Timesheets = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${($$result.head += `<title>Timesheets</title>`, "")}

	<h1>Timesheets</h1>

	<p>This is the 'timesheets' page. There's not much here.</p>`;
});
...
const css$3 = {
	code: ".selected.svelte-1xgnqc8{display:relative;color:white}a.svelte-1xgnqc8{text-decoration:none;padding:1em 0.5em}li.svelte-1xgnqc8{margin:0 1rem 0 1rem}.position-inherit.svelte-1xgnqc8{position:inherit}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script>\\n\\texport let segment;\\n</script>\\n\\n<style>\\n\\t.selected {\\n\\t\\tdisplay: relative;\\n\\t\\tcolor: white;\\n\\t}\\n\\n\\ta {\\n\\t\\ttext-decoration: none;\\n\\t\\tpadding: 1em 0.5em;\\n\\t}\\n\\n\\tli {\\n\\t\\tmargin: 0 1rem 0 1rem;\\n\\t}\\n\\n\\t.position-inherit {\\n\\t\\tposition: inherit;\\n\\t}\\n\\n</style>\\n\\n<nav class=\\\"bg-purple-700 md:bg-gray-300 font-light text-white md:text-gray-800 h-16 w-full fixed md:mt-16 bottom-0 md:bottom-auto\\\">\\n\\t<ul class=\\\"flex flex-row items-center justify-around md:justify-start md:mx-8\\\">\\n\\t\\t<li class=\\\"md:mx-4\\\">\\n\\t\\t\\t<a class='{segment === undefined ? \\\"text-orange-400\\\" : \\\"\\\"} flex' href='.'>\\n\\t\\t\\t\\t<svg class=\\\"fill-current inline-flex align-self h-6 w-6 mr-2\\\">\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#home\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p class=\\\"hidden md:block\\\">home<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t\\t<li class=\\\"md:mx-4\\\">\\n\\t\\t\\t<a rel=prefetch class='{segment === \\\"timesheets\\\" ? \\\"text-orange-400\\\" : \\\"\\\"} flex' href='timesheets'>\\n\\t\\t\\t\\t<svg class=\\\"fill-current inline-flex align-self h-6 w-6 mr-2\\\">\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#calendar-check\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p class=\\\"hidden md:block\\\">timesheets<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t\\t<li class=\\\"md:mx-4\\\">\\n\\t\\t\\t<a class='{segment === \\\"settings\\\" ? \\\"text-orange-400\\\" : \\\"\\\"} flex' href='settings'>\\n\\t\\t\\t\\t<svg class=\\\"fill-current inline-flex align-self h-6 w-6 mr-2\\\">\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#cog\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p class=\\\"hidden md:block\\\">settings<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t</ul>\\n</nav>\"],\"names\":[],\"mappings\":\"AAKC,SAAS,eAAC,CAAC,AACV,OAAO,CAAE,QAAQ,CACjB,KAAK,CAAE,KAAK,AACb,CAAC,AAED,CAAC,eAAC,CAAC,AACF,eAAe,CAAE,IAAI,CACrB,OAAO,CAAE,GAAG,CAAC,KAAK,AACnB,CAAC,AAED,EAAE,eAAC,CAAC,AACH,MAAM,CAAE,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,IAAI,AACtB,CAAC,AAED,iBAAiB,eAAC,CAAC,AAClB,QAAQ,CAAE,OAAO,AAClB,CAAC\"}"
};
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="bg-purple-700 md:bg-gray-300 font-light text-white md:text-gray-800 h-16 w-full fixed md:mt-16 bottom-0 md:bottom-auto">
		<ul class="flex flex-row items-center justify-around md:justify-start md:mx-8">
			<li class="md:mx-4 svelte-1xgnqc8">
				<a class="${escape(segment === undefined ? "text-orange-400" : "")} flex svelte-1xgnqc8" href=".">
					<svg class="fill-current inline-flex align-self h-6 w-6 mr-2">
						<use xlink:href="solid.svg#home"></use>
					</svg>
					<p class="hidden md:block">home</p><p>
				</p></a>
			</li>
			<li class="md:mx-4 svelte-1xgnqc8">
				<a rel="prefetch" class="${escape(segment === "timesheets" ? "text-orange-400" : "")} flex svelte-1xgnqc8" href="timesheets">
					<svg class="fill-current inline-flex align-self h-6 w-6 mr-2">
						<use xlink:href="solid.svg#calendar-check"></use>
					</svg>
					<p class="hidden md:block">timesheets</p><p>
				</p></a>
			</li>
			<li class="md:mx-4 svelte-1xgnqc8">
				<a class="${escape(segment === "settings" ? "text-orange-400" : "")} flex svelte-1xgnqc8" href="settings">
					<svg class="fill-current inline-flex align-self h-6 w-6 mr-2">
						<use xlink:href="solid.svg#cog"></use>
					</svg>
					<p class="hidden md:block">settings</p><p>
				</p></a>
			</li>
		</ul>
	</nav>`;
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/timesheets\/?$/,
			parts: [
				{ name: "timesheets", file: "timesheets.svelte", component: Timesheets }
			]
		},
