...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<object class="w-full svelte-11hl3yj" type="image/svg+xml" data="undraw_to_the_moon_v1mv.svg" title="illustration">Illustration</object>
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="theme-dark bg-default h-full min-h-screen">
