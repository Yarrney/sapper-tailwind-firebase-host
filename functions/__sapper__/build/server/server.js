...
/* src/components/Theme.svelte generated by Svelte v3.16.4 */
...
const Theme = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${$darkTheme
	? `<button class="${"btn btn-primary " + escape(classes)}">
		Toggle Dark Theme
	</button>`
	: `<button class="${"btn btn-primary " + escape(classes)}">
		Toggle Light Theme
...
<object class="${"w-full svelte-11hl3yj"}" type="${"image/svg+xml"}"${add_attribute("data", image, 0)} title="${"illustration"}">Illustration</object>
...
/* src/routes/settings.svelte generated by Svelte v3.16.4 */
...
/* src/routes/blog/index.svelte generated by Svelte v3.16.4 */

const css$2 = {
	code: "ul.svelte-rg91xj{margin:0 0 1em 0;line-height:1.5}h1.svelte-rg91xj{font-weight:700;font-size:2.25rem}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script context=\\\"module\\\">\\n\\timport Theme from '../../components/Theme.svelte';\\n\\n\\texport function preload({ params, query }) {\\n\\t\\treturn this.fetch(`blog.json`).then(r => r.json()).then(posts => {\\n\\t\\t\\treturn { posts };\\n\\t\\t});\\n\\t}\\n</script>\\n\\n<script>\\n\\texport let posts;\\n</script>\\n\\n<style>ul {\\n  margin: 0 0 1em 0;\\n  line-height: 1.5;\\n}\\n\\nh1 {\\n  font-weight: 700;\\n  font-size: 2.25rem;\\n}\\n\\t\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\\n<svelte:head>\\n\\t<title>Blog</title>\\n</svelte:head>\\n\\n<h1>Recent posts</h1>\\n\\n<ul>\\n\\t{#each posts as post}\\n\\t\\t<!-- we're using the non-standard `rel=prefetch` attribute to\\n\\t\\t\\t\\ttell Sapper to load the data for the page as soon as\\n\\t\\t\\t\\tthe user hovers over the link or taps it, instead of\\n\\t\\t\\t\\twaiting for the 'click' event -->\\n\\t\\t<li><a rel='prefetch' href='blog/{post.slug}'>{post.title}</a></li>\\n\\t{/each}\\n</ul>\\n\\n<Theme classes={\\\"flex mx-auto md:mx-0\\\"}/>\"],\"names\":[],\"mappings\":\"AAcO,EAAE,cAAC,CAAC,AACT,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CACjB,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,OAAO,AACpB,CAAC\"}"
};
...
<h1 class="${"svelte-rg91xj"}">Recent posts</h1>

<ul class="${"svelte-rg91xj"}">
	${each(posts, post => `
...
/* src/routes/blog/[slug].svelte generated by Svelte v3.16.4 */
...
/* src/components/Nav.svelte generated by Svelte v3.16.4 */

const css$4 = {
	code: "a.svelte-wd0edk{display:-webkit-box;display:flex;height:100%;-webkit-box-pack:center;justify-content:center;margin-left:0.5rem;margin-right:0.5rem;-webkit-box-align:center;align-items:center}svg.svelte-wd0edk{fill:currentColor;display:-webkit-inline-box;display:inline-flex;height:1.5rem;width:1.5rem;margin-right:0.5rem}p.svelte-wd0edk{display:none}@media(min-width: 768px){svg.svelte-wd0edk{display:none}p.svelte-wd0edk{display:block}li.svelte-wd0edk{height:100%}}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script>\\n\\texport let segment;\\n</script>\\n\\n<style>a {\\n  display: -webkit-box;\\n  display: flex;\\n  height: 100%;\\n  -webkit-box-pack: center;\\n          justify-content: center;\\n  margin-left: 0.5rem;\\n  margin-right: 0.5rem;\\n  -webkit-box-align: center;\\n          align-items: center;\\n}\\n\\nsvg {\\n  fill: currentColor;\\n  display: -webkit-inline-box;\\n  display: inline-flex;\\n  height: 1.5rem;\\n  width: 1.5rem;\\n  margin-right: 0.5rem;\\n}\\n\\np {\\n  display: none;\\n}\\n\\n@media (min-width: 768px) {\\n  .selected {\\n    color: var(--color-text-secondary);\\n    border-style: solid;\\n    border-bottom-width: 2px;\\n    border-color: #6b46c1;\\n    padding-top: 2px;\\n  }\\n\\n  svg {\\n    display: none;\\n  }\\n\\n  p {\\n    display: block;\\n  }\\n\\n  li {\\n    height: 100%;\\n  }\\n}\\n\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\\n<nav class=\\\"bg-primary md:bg-secondary font-light text-default md:text-default h-16 w-full fixed md:mt-16 bottom-0 md:bottom-auto\\\">\\n\\t<ul class=\\\"flex flex-row items-center justify-around md:justify-start md:mx-8 h-full\\\">\\n\\t\\t<li>\\n\\t\\t\\t<a class='{segment === undefined ? \\\"text-primary\\\" : \\\"\\\"}' href='.'>\\n\\t\\t\\t\\t<svg>\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#home\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p>home<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t\\t<li>\\n\\t\\t\\t<a rel=prefetch class='{segment === \\\"blog\\\" ? \\\"text-primary\\\" : \\\"\\\"}' href='blog'>\\n\\t\\t\\t\\t<svg>\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#calendar-check\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p>blog<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t\\t<li>\\n\\t\\t\\t<a class='{segment === \\\"settings\\\" ? \\\"text-primary\\\" : \\\"\\\"}' href='settings'>\\n\\t\\t\\t\\t<svg>\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#cog\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p>settings<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t</ul>\\n</nav>\"],\"names\":[],\"mappings\":\"AAIO,CAAC,cAAC,CAAC,AACR,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,gBAAgB,CAAE,MAAM,CAChB,eAAe,CAAE,MAAM,CAC/B,WAAW,CAAE,MAAM,CACnB,YAAY,CAAE,MAAM,CACpB,iBAAiB,CAAE,MAAM,CACjB,WAAW,CAAE,MAAM,AAC7B,CAAC,AAED,GAAG,cAAC,CAAC,AACH,IAAI,CAAE,YAAY,CAClB,OAAO,CAAE,kBAAkB,CAC3B,OAAO,CAAE,WAAW,CACpB,MAAM,CAAE,MAAM,CACd,KAAK,CAAE,MAAM,CACb,YAAY,CAAE,MAAM,AACtB,CAAC,AAED,CAAC,cAAC,CAAC,AACD,OAAO,CAAE,IAAI,AACf,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AASzB,GAAG,cAAC,CAAC,AACH,OAAO,CAAE,IAAI,AACf,CAAC,AAED,CAAC,cAAC,CAAC,AACD,OAAO,CAAE,KAAK,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,MAAM,CAAE,IAAI,AACd,CAAC,AACH,CAAC\"}"
};
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<ul class="${"flex flex-row items-center justify-around md:justify-start md:mx-8 h-full"}">
		<li class="${"svelte-wd0edk"}">
			<a class="${escape(null_to_empty(segment === undefined ? "text-primary" : "")) + " svelte-wd0edk"}" href="${"."}">
				<svg class="${"svelte-wd0edk"}">
					<use xlink:href="${"solid.svg#home"}"></use>
				</svg>
				<p class="${"svelte-wd0edk"}">home</p><p class="${"svelte-wd0edk"}">
			</p></a>
		</li>
		<li class="${"svelte-wd0edk"}">
			<a rel="${"prefetch"}" class="${escape(null_to_empty(segment === "blog" ? "text-primary" : "")) + " svelte-wd0edk"}" href="${"blog"}">
				<svg class="${"svelte-wd0edk"}">
					<use xlink:href="${"solid.svg#calendar-check"}"></use>
				</svg>
				<p class="${"svelte-wd0edk"}">blog</p><p class="${"svelte-wd0edk"}">
			</p></a>
		</li>
		<li class="${"svelte-wd0edk"}">
			<a class="${escape(null_to_empty(segment === "settings" ? "text-primary" : "")) + " svelte-wd0edk"}" href="${"settings"}">
				<svg class="${"svelte-wd0edk"}">
					<use xlink:href="${"solid.svg#cog"}"></use>
				</svg>
				<p class="${"svelte-wd0edk"}">settings</p><p class="${"svelte-wd0edk"}">
			</p></a>
		</li>
	</ul>
</nav>`;
...
/* src/node_modules/@sapper/internal/App.svelte generated by Svelte v3.16.4 */
