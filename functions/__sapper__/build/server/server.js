...
/* src/components/Theme.svelte generated by Svelte v3.22.2 */
...
const Theme = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${$darkTheme
	? `<button class="${"btn btn-primary " + escape(classes)}">Toggle Dark Theme
	</button>`
	: `<button class="${"btn btn-primary " + escape(classes)}">Toggle Light Theme
	</button>`}`;
});
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${($$result.head += `${($$result.title = `<title>Sapper Template</title>`, "")}`, "")}
...
/* src/routes/settings.svelte generated by Svelte v3.22.2 */
...
<div class="${"flex flex-col md:flex-row"}"><button class="${"btn btn-primary mt-4 md:mr-2"}">Primary Button
	</button>

	<button class="${"btn btn-secondary mt-2 md:mt-4"}">Secondary Button
	</button></div>
...
/* src/routes/blog/index.svelte generated by Svelte v3.22.2 */
...
<ul class="${"svelte-rg91xj"}">${each(posts, post => `
...
/* src/routes/blog/[slug].svelte generated by Svelte v3.22.2 */
...
<div class="${"content svelte-1snaucg"}">${post.html}</div>`;
});

/* src/components/Nav.svelte generated by Svelte v3.22.2 */

const css$4 = {
	code: "a.svelte-k0l2bj{display:flex;height:100%;justify-content:center;margin-left:0.5rem;margin-right:0.5rem;align-items:center}svg.svelte-k0l2bj{fill:currentColor;display:inline-flex;height:1.5rem;width:1.5rem;margin-right:0.5rem}p.svelte-k0l2bj{display:none}@media(min-width: 768px){svg.svelte-k0l2bj{display:none}p.svelte-k0l2bj{display:block}li.svelte-k0l2bj{height:100%}}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script>\\n\\texport let segment;\\n</script>\\n\\n<style>a {\\n  display: flex;\\n  height: 100%;\\n  justify-content: center;\\n  margin-left: 0.5rem;\\n  margin-right: 0.5rem;\\n  align-items: center;\\n}\\n\\nsvg {\\n  fill: currentColor;\\n  display: inline-flex;\\n  height: 1.5rem;\\n  width: 1.5rem;\\n  margin-right: 0.5rem;\\n}\\n\\np {\\n  display: none;\\n}\\n\\n@media (min-width: 768px) {\\n  .selected {\\n    color: var(--color-text-secondary);\\n    border-style: solid;\\n    border-bottom-width: 2px;\\n    --border-opacity: 1;\\n    border-color: #6b46c1;\\n    border-color: rgba(107, 70, 193, var(--border-opacity));\\n    padding-top: 2px;\\n  }\\n\\n  svg {\\n    display: none;\\n  }\\n\\n  p {\\n    display: block;\\n  }\\n\\n  li {\\n    height: 100%;\\n  }\\n}\\n\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\\n<nav class=\\\"bg-primary md:bg-secondary font-light text-default md:text-default h-16 w-full fixed md:mt-16 bottom-0 md:bottom-auto\\\">\\n\\t<ul class=\\\"flex flex-row items-center justify-around md:justify-start md:mx-8 h-full\\\">\\n\\t\\t<li>\\n\\t\\t\\t<a class='{segment === undefined ? \\\"text-primary\\\" : \\\"\\\"}' href='.'>\\n\\t\\t\\t\\t<svg>\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#home\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p>home<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t\\t<li>\\n\\t\\t\\t<a rel=prefetch class='{segment === \\\"blog\\\" ? \\\"text-primary\\\" : \\\"\\\"}' href='blog'>\\n\\t\\t\\t\\t<svg>\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#calendar-check\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p>blog<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t\\t<li>\\n\\t\\t\\t<a class='{segment === \\\"settings\\\" ? \\\"text-primary\\\" : \\\"\\\"}' href='settings'>\\n\\t\\t\\t\\t<svg>\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#cog\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p>settings<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t</ul>\\n</nav>\"],\"names\":[],\"mappings\":\"AAIO,CAAC,cAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,YAAY,CAAE,MAAM,CACpB,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,GAAG,cAAC,CAAC,AACH,IAAI,CAAE,YAAY,CAClB,OAAO,CAAE,WAAW,CACpB,MAAM,CAAE,MAAM,CACd,KAAK,CAAE,MAAM,CACb,YAAY,CAAE,MAAM,AACtB,CAAC,AAED,CAAC,cAAC,CAAC,AACD,OAAO,CAAE,IAAI,AACf,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAWzB,GAAG,cAAC,CAAC,AACH,OAAO,CAAE,IAAI,AACf,CAAC,AAED,CAAC,cAAC,CAAC,AACD,OAAO,CAAE,KAAK,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,MAAM,CAAE,IAAI,AACd,CAAC,AACH,CAAC\"}"
};
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"bg-primary md:bg-secondary font-light text-default md:text-default h-16 w-full fixed md:mt-16 bottom-0 md:bottom-auto"}"><ul class="${"flex flex-row items-center justify-around md:justify-start md:mx-8 h-full"}"><li class="${"svelte-k0l2bj"}"><a class="${escape(null_to_empty(segment === undefined ? "text-primary" : "")) + " svelte-k0l2bj"}" href="${"."}"><svg class="${"svelte-k0l2bj"}"><use xlink:href="${"solid.svg#home"}"></use></svg>
				<p class="${"svelte-k0l2bj"}">home</p><p class="${"svelte-k0l2bj"}"></p></a></li>
		<li class="${"svelte-k0l2bj"}"><a rel="${"prefetch"}" class="${escape(null_to_empty(segment === "blog" ? "text-primary" : "")) + " svelte-k0l2bj"}" href="${"blog"}"><svg class="${"svelte-k0l2bj"}"><use xlink:href="${"solid.svg#calendar-check"}"></use></svg>
				<p class="${"svelte-k0l2bj"}">blog</p><p class="${"svelte-k0l2bj"}"></p></a></li>
		<li class="${"svelte-k0l2bj"}"><a class="${escape(null_to_empty(segment === "settings" ? "text-primary" : "")) + " svelte-k0l2bj"}" href="${"settings"}"><svg class="${"svelte-k0l2bj"}"><use xlink:href="${"solid.svg#cog"}"></use></svg>
				<p class="${"svelte-k0l2bj"}">settings</p><p class="${"svelte-k0l2bj"}"></p></a></li></ul></nav>`;
});
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${escape($darkTheme ? "theme-dark" : "theme-basic") + " bg-default h-full min-h-screen"}"><div class="${"fixed top-0 h-16 w-full flex flex-row items-center justify-around bg-primary text-primary font-extrabold text-3xl"}">This is a title.
	</div>

	${validate_component(Nav, "Nav").$$render($$result, { segment }, {}, {})}

	<main class="${"text-default pt-20 md:pt-40 px-8 pb-8 max-w-4xl mx-auto"}">${$$slots.default ? $$slots.default({}) : ``}</main></div>`;
});
