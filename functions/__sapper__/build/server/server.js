...
const css = {
	code: "h1.svelte-jtxo38,object.svelte-jtxo38{text-align:center;margin:0 auto}h1.svelte-jtxo38{font-size:2.8em;text-transform:uppercase;font-weight:700;margin:0 0 0.5em 0}object.svelte-jtxo38{width:100%;max-width:700px;margin:0 auto 1em auto}@media(min-width: 480px){h1.svelte-jtxo38{font-size:4em}}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<style>h1, object, p {\\n  text-align: center;\\n  margin: 0 auto;\\n}\\n\\nh1 {\\n  font-size: 2.8em;\\n  text-transform: uppercase;\\n  font-weight: 700;\\n  margin: 0 0 0.5em 0;\\n}\\n\\nobject {\\n  width: 100%;\\n  max-width: 700px;\\n  margin: 0 auto 1em auto;\\n}\\n\\n@media (min-width: 480px) {\\n  h1 {\\n    font-size: 4em;\\n  }\\n}\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\\n<svelte:head>\\n\\t<title>Your project title</title>\\n</svelte:head>\\n\\n<h1>Great success!</h1>\\n\\n<object class=\\\"w-full\\\" type=\\\"image/svg+xml\\\" data=\\\"illustration.svg\\\" title=\\\"illustration\\\">Illustration</object>\\n\"],\"names\":[],\"mappings\":\"AAAO,gBAAE,CAAE,MAAM,cAAI,CAAC,AACpB,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AACrB,CAAC,AAED,MAAM,cAAC,CAAC,AACN,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,CAAC,CAAC,IAAI,CAAC,GAAG,CAAC,IAAI,AACzB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,GAAG,AAChB,CAAC,AACH,CAAC\"}"
};

const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css);

	return `${($$result.head += `<title>Your project title</title>`, "")}

	<h1 class="svelte-jtxo38">Great success!</h1>

	<object class="w-full svelte-jtxo38" type="image/svg+xml" data="illustration.svg" title="illustration">Illustration</object>`;
});
...
const css$4 = {
	code: "a.svelte-5uwfbn{display:flex;text-decoration:none;height:100%;justify-content:center;margin-left:0.5rem;margin-right:0.5rem;align-items:center}.selected.svelte-5uwfbn{color:#fff}svg.svelte-5uwfbn{fill:currentColor;display:inline-flex;height:1.5rem;width:1.5rem;margin-right:0.5rem}p.svelte-5uwfbn{display:none}@media(min-width: 768px){.selected.svelte-5uwfbn{color:#6b46c1;border-style:solid;border-bottom-width:2px;border-color:#6b46c1;padding-top:2px}svg.svelte-5uwfbn{display:none}p.svelte-5uwfbn{display:block}li.svelte-5uwfbn{height:100%}}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script>\\n\\texport let segment;\\n</script>\\n\\n<style>a {\\n  display: flex;\\n  text-decoration: none;\\n  height: 100%;\\n  justify-content: center;\\n  margin-left: 0.5rem;\\n  margin-right: 0.5rem;\\n  align-items: center;\\n}\\n\\n.selected {\\n  color: #fff;\\n}\\n\\nsvg {\\n  fill: currentColor;\\n  display: inline-flex;\\n  height: 1.5rem;\\n  width: 1.5rem;\\n  margin-right: 0.5rem;\\n}\\n\\np {\\n  display: none;\\n}\\n\\n@media (min-width: 768px) {\\n  .selected {\\n    color: #6b46c1;\\n    border-style: solid;\\n    border-bottom-width: 2px;\\n    border-color: #6b46c1;\\n    padding-top: 2px;\\n  }\\n\\n  svg {\\n    display: none;\\n  }\\n\\n  p {\\n    display: block;\\n  }\\n\\n  li {\\n    height: 100%;\\n  }\\n}\\n\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\\n<nav class=\\\"bg-purple-700 md:bg-gray-300 font-light text-purple-400 md:text-gray-800 h-16 w-full fixed md:mt-16 bottom-0 md:bottom-auto\\\">\\n\\t<ul class=\\\"flex flex-row items-center justify-around md:justify-start md:mx-8 h-full\\\">\\n\\t\\t<li>\\n\\t\\t\\t<a class='{segment === undefined ? \\\"selected\\\" : \\\"\\\"}' href='.'>\\n\\t\\t\\t\\t<svg>\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#home\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p>home<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t\\t<li>\\n\\t\\t\\t<a rel=prefetch class='{segment === \\\"blog\\\" ? \\\"selected\\\" : \\\"\\\"}' href='blog'>\\n\\t\\t\\t\\t<svg>\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#calendar-check\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p>blog<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t\\t<li>\\n\\t\\t\\t<a class='{segment === \\\"settings\\\" ? \\\"selected\\\" : \\\"\\\"}' href='settings'>\\n\\t\\t\\t\\t<svg>\\n\\t\\t\\t\\t\\t<use xlink:href=\\\"solid.svg#cog\\\"></use>\\n\\t\\t\\t\\t</svg>\\n\\t\\t\\t\\t<p>settings<p>\\n\\t\\t\\t</a>\\n\\t\\t</li>\\n\\t</ul>\\n</nav>\"],\"names\":[],\"mappings\":\"AAIO,CAAC,cAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,IAAI,CACrB,MAAM,CAAE,IAAI,CACZ,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,YAAY,CAAE,MAAM,CACpB,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,SAAS,cAAC,CAAC,AACT,KAAK,CAAE,IAAI,AACb,CAAC,AAED,GAAG,cAAC,CAAC,AACH,IAAI,CAAE,YAAY,CAClB,OAAO,CAAE,WAAW,CACpB,MAAM,CAAE,MAAM,CACd,KAAK,CAAE,MAAM,CACb,YAAY,CAAE,MAAM,AACtB,CAAC,AAED,CAAC,cAAC,CAAC,AACD,OAAO,CAAE,IAAI,AACf,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,SAAS,cAAC,CAAC,AACT,KAAK,CAAE,OAAO,CACd,YAAY,CAAE,KAAK,CACnB,mBAAmB,CAAE,GAAG,CACxB,YAAY,CAAE,OAAO,CACrB,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,GAAG,cAAC,CAAC,AACH,OAAO,CAAE,IAAI,AACf,CAAC,AAED,CAAC,cAAC,CAAC,AACD,OAAO,CAAE,KAAK,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,MAAM,CAAE,IAAI,AACd,CAAC,AACH,CAAC\"}"
};
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="bg-purple-700 md:bg-gray-300 font-light text-purple-400 md:text-gray-800 h-16 w-full fixed md:mt-16 bottom-0 md:bottom-auto">
		<ul class="flex flex-row items-center justify-around md:justify-start md:mx-8 h-full">
			<li class="svelte-5uwfbn">
				<a class="${escape(segment === undefined ? "selected" : "")} svelte-5uwfbn" href=".">
					<svg class="svelte-5uwfbn">
						<use xlink:href="solid.svg#home"></use>
					</svg>
					<p class="svelte-5uwfbn">home</p><p class="svelte-5uwfbn">
				</p></a>
			</li>
			<li class="svelte-5uwfbn">
				<a rel="prefetch" class="${escape(segment === "blog" ? "selected" : "")} svelte-5uwfbn" href="blog">
					<svg class="svelte-5uwfbn">
						<use xlink:href="solid.svg#calendar-check"></use>
					</svg>
					<p class="svelte-5uwfbn">blog</p><p class="svelte-5uwfbn">
				</p></a>
			</li>
			<li class="svelte-5uwfbn">
				<a class="${escape(segment === "settings" ? "selected" : "")} svelte-5uwfbn" href="settings">
					<svg class="svelte-5uwfbn">
						<use xlink:href="solid.svg#cog"></use>
					</svg>
					<p class="svelte-5uwfbn">settings</p><p class="svelte-5uwfbn">
				</p></a>
			</li>
		</ul>
	</nav>`;
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="fixed top-0 bg-purple-700 h-16 w-full text-white flex flex-row items-center justify-around font-extrabold text-3xl">
		Timesheets
	</div>
